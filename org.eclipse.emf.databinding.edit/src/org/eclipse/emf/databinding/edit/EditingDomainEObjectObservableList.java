...
public class EditingDomainEObjectObservableList extends EObjectObservableList {
	 ...
	 *             {@link EMFEditObservables#observeList(EditingDomain, EObject, EStructuralFeature)}
	 */
	 ...
	 *            the feature observed
	 * @deprecated you should use
	 *             {@link EMFEditObservables#observeList(Realm, EditingDomain, EObject, EStructuralFeature)}
	 */
	...
	public boolean add(Object object) {
		checkRealm();
		return execute(AddCommand.create(domain, eObject, eStructuralFeature,
				object));
	}
	...
	public void add(int index, Object object) {
		checkRealm();
		execute(AddCommand.create(domain, eObject, eStructuralFeature, object,
				index));
	}
	...
	public Object set(int index, Object element) {
		...
		execute(SetCommand.create(domain, eObject, eStructuralFeature, element,
				index));
		return oldElement;
	}
	...
	public Object remove(int index) {
		...
		execute(RemoveCommand.create(domain, eObject, eStructuralFeature,
				element));
		return element;
	}
	...
	public boolean remove(Object element) {
		checkRealm();
		return execute(RemoveCommand.create(domain, eObject,
	...
	public boolean retainAll(Collection collection) {
		...
		return execute(RemoveCommand.create(domain, eObject,
				eStructuralFeature, objectsToRemove));
	}
	...
	public void clear() {
		checkRealm();
		execute(RemoveCommand.create(domain, eObject, eStructuralFeature,
				new ArrayList<Object>(wrappedList())));
	}
	...
	public void move(int newPosition, Object object) {
		checkRealm();
		execute(MoveCommand.create(domain, eObject, eStructuralFeature, object,
				newPosition));
	}
}